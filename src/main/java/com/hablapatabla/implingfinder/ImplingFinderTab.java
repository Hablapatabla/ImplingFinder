...
@Getter
public enum ImplingFinderTab
{
    // Chest Rewards
    BABY("Baby", ItemID.BABY_IMPLING_JAR, "Other", LootRecordType.EVENT),
    ...
    ImplingFinderTab(final String name, final int itemID, final String category, final LootRecordType type, final String... aliases)
    {
        this(name, itemID, category, type, Collections.emptyList(), aliases);
    }

    ImplingFinderTab(final String name, final int itemID, final String category, final LootRecordType type, final Collection<String> minions, final String... aliases)
    {
        this.name = name;
        this.itemID = itemID;
    ...
    private static final Map<String, ImplingFinderTab> NAME_MAP;
    private static final Multimap<String, ImplingFinderTab> CATEGORY_MAP;
    static
    {
        final ImmutableMap.Builder<String, ImplingFinderTab> byName = ImmutableMap.builder();
        final ImmutableMultimap.Builder<String, ImplingFinderTab> categoryMap = ImmutableMultimap.builder();

        for (ImplingFinderTab tab : values())
        {
    ...
    @Nullable
    public static ImplingFinderTab getByName(final String name)
    {
        return NAME_MAP.get(name.toUpperCase());
    }

    public static Collection<ImplingFinderTab> getByCategoryName(final String name)
    {
